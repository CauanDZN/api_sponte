 ...
 *         &lt;element name="nInadimplente" type="{http://www.w3.org/2001/XMLSchema}int"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "SetInadimplente")
public class SetInadimplente {

    protected int nCodigoCliente;
    protected String sToken;
    protected int nAlunoID;
    protected int nInadimplente;
    ...
    /**
     * Obtém o valor da propriedade nInadimplente.
     * 
     */
    public int getNInadimplente() {
        return nInadimplente;
    }

    /**
     * Define o valor da propriedade nInadimplente.
     * 
     */
    public void setNInadimplente(int value) {
        this.nInadimplente = value;
    }
