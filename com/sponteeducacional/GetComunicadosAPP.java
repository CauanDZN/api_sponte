 ...
 *         &lt;element name="nNumeroPagina" type="{http://www.w3.org/2001/XMLSchema}int"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GetComunicadosAPP")
public class GetComunicadosAPP {

    protected int nCodigoCliente;
    protected String sToken;
    protected String sParametrosBusca;
    protected int nNumeroPagina;
    ...
    /**
     * Obtém o valor da propriedade nNumeroPagina.
     * 
     */
    public int getNNumeroPagina() {
        return nNumeroPagina;
    }

    /**
     * Define o valor da propriedade nNumeroPagina.
     * 
     */
    public void setNNumeroPagina(int value) {
        this.nNumeroPagina = value;
    }
